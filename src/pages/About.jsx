  ...
  return (
    <>
      <Grid container sx={{ mb: '1rem' }}>
        ...
        <Grid item xs={12} display="flex" justifyContent="center" alignItems="center">
          <Typography variant="h2">보호에 취약한 가출 청소년의 내일을 위해.</Typography>
        </Grid>
      </Grid>
      ...
      >
        ...
        >
          <Grid item xs={12} display="flex" justifyContent="center">
            <Typography variant="h2">2020년 기준, 가출 청소년 약 12만명.</Typography>
          </Grid>
          <Grid item xs={12} display="flex" justifyContent="center">
      ...
      >
        ...
        >
          <Grid item xs={12}>
            <Typography variant="h2">세상의 모든 가출청소년을 위해</Typography>
          </Grid>
          <Grid item xs={12}>
            <Typography variant="h3">
          ...
          <Grid item xs={12}>
            <Typography variant="h4">공공 청소년 쉼터는 턱없이 부족합니다.</Typography>
            <Typography variant="body1">
